...
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-brand border-l-4 border-gold pl-3", children: title }),
    linkLabel && linkHref && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: linkHref,
...
function AdventureSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: tours$4.map((tour, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 right-3 bg-gold text-white text-sm font-bold px-2.5 py-1 rounded", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-normal", children: "From" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1", children: [
                "¥",
                tour.price
              ] })
            ] }),
            tour.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 bg-brand text-white text-xs px-2 py-1 rounded font-medium max-w-[70%]", children: tour.badge })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-800 text-sm leading-snug mb-3 group-hover:text-brand transition-colors line-clamp-2", children: tour.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-gray-500", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 11, className: "text-gold" }),
...
function AfricaBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-brand/75" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-4 text-center text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold font-semibold text-sm uppercase tracking-widest mb-2", children: "Africa Multi-Country Group Tours" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold mb-4", children: "Fixed Departure Dates — Great Group Prices!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-center gap-3 text-white/80 text-sm mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Travel with adventurers from around the world" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block text-gold", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Up to 57 days traversing the African continent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block text-gold", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Includes Kenya | Tanzania | Uganda | Malawi | Zambia | Zimbabwe | Botswana | Namibia | South Africa & more" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
const tours$3 = [
  ...
  {
    title: "Antarctic Peninsula + Elephant Island + Weddell Sea + Crossing the Circle 15 Days",
    image: "/assets/generated/dest-antarctica.dim_700x500.jpg",
    price: "45,990",
  ...
  {
    title: "Antarctic Peninsula + Crossing the Antarctic Circle In-Depth 14 Days",
    image: "/assets/generated/tour-antarctica-ship.dim_700x500.jpg",
    price: "49,640",
    originalPrice: "66,430",
    duration: "14 Days / 13 Nights",
...
function AntarcticaSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: tours$3.map((tour, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "tour-card group bg-white rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 cursor-pointer",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 right-3 bg-gold text-white text-sm font-bold px-2.5 py-1 rounded", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-normal", children: "From" }),
              tour.originalPrice && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs line-through opacity-70 ml-1", children: [
                "¥",
                tour.originalPrice
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1", children: [
            ...
            tour.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 bg-brand text-white text-xs px-2 py-1 rounded font-medium", children: tour.badge })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-800 text-sm leading-snug mb-3 group-hover:text-brand transition-colors", children: tour.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-gray-500", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 11, className: "text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tour.duration })
            ] })
...
function DestinationsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: destinations$1.map((dest, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 left-3 bg-brand/90 text-white text-xs px-2 py-1 rounded font-medium", children: [
            dest.routes,
            " Routes"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dest-card-overlay absolute inset-0 bg-black/50 opacity-0 transition-opacity duration-300 flex flex-col items-center justify-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-xl", children: dest.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-lg", children: dest.name }) })
        ]
      },
      dest.name
    )) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-800 text-sm leading-snug mb-3 line-clamp-2 group-hover:text-brand transition-colors", children: tour.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-xs text-gray-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 11, className: "text-gold flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tour.duration })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 11, className: "text-gold flex-shrink-0" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 11, className: "text-gold flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tour.location })
            ] })
          ] })
        ] })
      ]
...
function FeaturedToursSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: tours$2.map((tour, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      TourCard,
      {
        tour,
        ocid: `tour.item.${i + 1}`
...
function SiFlickr(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M5.334 6.666C2.3884 6.666 0 9.055 0 12c0 2.9456 2.3884 5.334 5.334 5.334 2.9456 0 5.332-2.3884 5.332-5.334 0-2.945-2.3864-5.334-5.332-5.334zm13.332 0c-2.9456 0-5.332 2.389-5.332 5.334 0 2.9456 2.3864 5.334 5.332 5.334C21.6116 17.334 24 14.9456 24 12c0-2.945-2.3884-5.334-5.334-5.334Z" }, "child": [] }] })(props);
}
function SiX(props) {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-brand text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-4 text-gold", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-sm text-white/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "mt-0.5 text-gold flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Wanxiang City, Xiufeng District, Guilin, Guangxi, China" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "+86 189 0773 3818"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs font-bold", children: "WeChat" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "One2Travel" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "hover:text-white transition-colors",
                children: "contact@efindtravel.com"
              }
            )
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-4 text-gold", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 text-sm text-white/80", children: quickLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-4 text-gold", children: "Follow Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5 text-sm text-white/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            "WeChat: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-white", children: "One2Travel" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { size: 14, className: "text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "hover:text-gold transition-colors",
                children: "EfindTravel"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 14, className: "text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-4 text-gold", children: "Scan to Add WeChat" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 bg-white/10 rounded flex items-center justify-center border border-white/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: "💬" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-white/60 mt-1", children: "One2Travel" })
        ] }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between text-xs text-white/50 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "EFind Travel © ",
        year,
        " All Rights Reserved"
...
const guides = [
  {
    title: "International Travel Health Certificate: Yellow Card (International Certificate of Vaccination) Application Guide & FAQs",
    image: "/assets/generated/dest-tanzania.dim_700x500.jpg"
  },
  {
...
function GuidesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: guides.map((guide, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: "/guide",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden aspect-video", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: guide.image,
              alt: guide.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-700 leading-snug line-clamp-3 group-hover:text-brand transition-colors", children: guide.title }) })
        ]
      },
      guide.title
    )) })
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "flex items-center gap-2", "data-ocid": "nav.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand font-bold text-lg leading-tight tracking-wide", children: "EFind Travel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-[10px] font-display font-semibold tracking-[0.2em] leading-none", children: "EFIND TRAVEL" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-0.5", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-item relative group", children: [
            ...
            item.children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "nav-dropdown absolute top-full left-0 bg-white shadow-lg border border-gray-100 rounded min-w-[200px] py-1 opacity-0 invisible transform -translate-y-1 transition-all duration-150 z-50", children: item.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: child.href,
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-white border-t border-gray-100 shadow-lg", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          item.children && openDropdown === item.label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-50 border-t border-gray-100", children: item.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: child.href,
...
function HeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[580px] md:h-[680px] flex items-center justify-center overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: "/assets/generated/hero-africa.dim_1800x900.jpg",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/55 via-black/40 to-black/60" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center text-white px-4 max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl font-bold mb-3 drop-shadow-lg tracking-wide", children: "Explore a Diverse World — We'll Take You There!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base md:text-lg text-white/85 mb-8 font-light", children: "Explore the world's best destinations with us and enjoy the difference." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-3 flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            value: dest,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Destination" }),
              destinations.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: d, children: d }, d))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            "data-ocid": "search.select",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Duration" }),
              durations.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: d, children: d }, d))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
const tours$1 = [
  {
    title: "Latin America: Mexico + Cuba + Brazil + Argentina + Chile + Peru 6-Country 31 Days",
  ...
  {
    title: "Caribbean 5-Country: Mexico + Cuba + Jamaica + Panama + Costa Rica 19 Days",
    image: "/assets/generated/tour-cuba.dim_700x500.jpg",
  ...
  {
    title: "Latin America Explorer: Brazil + Argentina + Chile + Peru 4-Country 24 Days",
    image: "/assets/generated/tour-peru.dim_700x500.jpg",
  ...
  {
    title: "Latin America Explorer: Brazil + Argentina + Chile + Peru 4-Country 22 Days",
    image: "/assets/generated/tour-peru.dim_700x500.jpg",
    badge: "Guaranteed Departure",
...
function LatinAmericaSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5", children: tours$1.map((tour, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "tour-card group bg-white rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 cursor-pointer",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" }),
            tour.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 bg-gold text-white text-xs px-2 py-1 rounded font-bold", children: tour.badge })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-800 text-sm leading-snug mb-3 line-clamp-2 group-hover:text-brand transition-colors", children: tour.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-xs text-gray-500", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 11, className: "text-gold flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tour.cities })
              ] })
            ] })
          ] })
        ]
...
function LuxurySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gold font-medium mb-1", children: "Create an exclusive escape for you and your family" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Holiday Packages" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 -mt-4", children: "East African savanna, South American jungle, or a secluded island" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: tours.map((tour, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "tour-card group bg-white rounded-lg overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 cursor-pointer",
...
function TopBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-brand text-white text-sm py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+86 189 0773 3818" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Contact@EfindTravel.com" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          className: "hover:text-gold transition-colors",
          "aria-label": "Facebook",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { size: 13 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          className: "hover:text-gold transition-colors",
          "aria-label": "Flickr",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFlickr, { size: 13 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          className: "hover:text-gold transition-colors",
          "aria-label": "Twitter",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { size: 13 })
        }
      )
    ] })
  ] }) });
...
function TravelTypesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-brand border-l-4 border-gold pl-3 mb-6", children: "Browse by Travel Type" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 md:grid-cols-8 gap-3", children: types.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: t.href,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-700 group-hover:text-brand transition-colors leading-tight", children: t.label })
        ]
      },
      t.label
    )) })
...
function USPSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: usps.map((usp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-full bg-gold/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(usp.icon, { size: 22, className: "text-gold" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-1", children: usp.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-sm leading-relaxed", children: usp.desc })
    ] })
  ] }, usp.title)) }) }) });
}
const queryClient$1 = new QueryClient();
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedToursSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LatinAmericaSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AfricaBanner, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AntarcticaSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AdventureSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LuxurySection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TravelTypesSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(GuidesSection, {})
    ] }),
...
class FuncClass extends ConstructType {
  ...
  static argsToString(types2, v) {
    if (types2.length !== v.length) {
      throw new Error("arity mismatch");
    }
    return "(" + types2.map((t, i) => t.valueToString(v[i])).join(", ") + ")";
  }
...
const Tour = Record({
  "title": Text,
  "duration": Record({ "days": Nat, "nights": Nat }),
  "departureInfo": Text,
...
Service({
  "getAllToursByCategory": Func(
    [TourCategory],
    [Vec(Tour)],
    ["query"]
  ),
  "getAllToursSortedByPrice": Func([], [Vec(Tour)], ["query"]),
  "getDestinations": Func([], [Vec(Destination)], ["query"]),
  "getDestinationsByRegion": Func(
    [Text],
    [Vec(Destination)],
    ["query"]
  ),
  "getDestinationsSortedByRouteCount": Func(
    [],
    [Vec(Destination)],
    ["query"]
  ),
  "getGuides": Func([], [Vec(Guide)], ["query"]),
  "getGuidesByCategory": Func(
    [GuideCategory],
    [Vec(Guide)],
    ["query"]
  ),
  "getTours": Func([], [Vec(Tour)], ["query"]),
  "getToursByCategory": Func([TourCategory], [Vec(Tour)], ["query"]),
  "getToursByPriceRange": Func(
    [Nat, Nat],
    [Vec(Tour)],
    ["query"]
  )
